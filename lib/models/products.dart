...
class Products {
  ...
  final List<Items> _products = [
    ...
    Items(
      ...
      status: 'Available',
      imagePath: 'assets/images/bottom_5.jpg',
    ),
    ...
    Items(
      ...
      status: 'Available',
      imagePath: 'assets/images/outerwear_1.jpg',
    ),
    Items(
      itemID: 17,
      title: 'WOOL OVERCOAT',
      ...
      status: 'Available',
      imagePath: 'assets/images/outerwear_2.jpg',
    ),
    Items(
      itemID: 18,
      title: 'BOMBER JACKET',
      ...
      status: 'Available',
      imagePath: 'assets/images/outerwear_3.jpg',
    ),
    Items(
      itemID: 19,
      title: 'WINDBREAKER',
      ...
      status: 'Available',
      imagePath: 'assets/images/outerwear_4.jpg',
    ),
    Items(
      itemID: 20,
      ...
      status: 'Available',
      imagePath: 'assets/images/outerwear_5.jpg',
    ),
    ...
    Items(
      ...
      status: 'Available',
      imagePath: 'assets/images/undergarment_1.jpg',
    ),
    Items(
      itemID: 22,
      ...
      status: 'Available',
      imagePath: 'assets/images/undergarment_2.jpg',
    ),
    Items(
      itemID: 23,
      ...
      status: 'Available',
      imagePath: 'assets/images/undergarment_3.jpg',
    ),
    Items(
      itemID: 24,
      ...
      status: 'Available',
      imagePath: 'assets/images/undergarment_4.jpg',
    ),
    Items(
      itemID: 25,
      ...
      status: 'Available',
      imagePath: 'assets/images/undergarment_5.jpg',
    ),
  ];
